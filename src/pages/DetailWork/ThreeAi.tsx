...
import herovideo from "../../assets/aps three ai.mp4";
import {
  FaFigma,
  FaLongArrowAltRight,
  FaQuoteRight,
...
import homepage from "../../assets/ApiHome.png";
    ...
    <div className=" justify-center items-center w-full  ">
      ...
      <div className="my-20 justify-center items-center w-full">
        <p className="px-4 sm:px-20  text-xl text-justify font-poppins font-medium text-[#565656] justify-start lg:text-left">
          APS THREEAI offers premier healthcare ERP solutions, encompassing
          digital records management, inventory control, and advanced analytics.
          Renowned for its user-friendly features and robust technology, the
          platform ensures efficient healthcare management. Explore meticulously
          crafted ERP solutions tailored to your needs today.
        </p>
      </div>

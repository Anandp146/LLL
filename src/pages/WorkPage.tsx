...
const WorkPage: React.FC = () => {
  ...
  return (
    // <div className="pt-12 pb-12 lg:pt-16 lg:pb-16">
    //   <div className="top-12 flex flex-col lg:flex-row justify-center items-center bg-white p-10">
    ...
    //     <div className="text-2xl  w-[425px] items-center  text-[#676767] ">
    //       <span className="text-green-700 text-3xl">&ldquo; </span>
    //       <span className="w-[400px] h-[99px] justify-center">
    //         We craft intuitive products aligned with our client's business
    //         goals.
    //       </span>
    //       <span className="text-green-700 text-3xl">&rdquo;</span>
    //     </div>
    //   </div>
    ...
    //     <div
    //       key={workItem.id}
    //       className={`rounded-lg w-full mx-auto overflow-hidden shadow-lg flex flex-col lg:flex-row items-center justify-center bg-cover bg-center`}
    //       style={{
    ...
    //         <div className="w-full sm:w-11/12  lg:w-1/2 object-cover mx-0 h-[340px] md:mx-6 rounded-xl flex flex-col justify-center items-center mb-6 lg:mb-0">
    //           <img
    ...
    //           </div>
    //           <p
    //             className={`h-auto my-6 text-sm md:text-base
    ...
    //           </div>
    //           <button
    //             className={`bg-transparent border py-2 px-6 w-full sm:w-[30%] font-bold text-xl rounded-full transition duration-1000
    // ${
    //   index % 2 !== 0

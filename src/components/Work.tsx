...
const Work: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className=" relative flex flex-col items-center sm:my-14  justify-center px-8  md:px-6 lg:px-10">
        <div>
            ...
            <div className="flex flex-col lg:flex-row  items-center justify-center">
              ...
              <div className="w-full sm:w-11/12 my-10 lg:w-full p-6 md:p-8  shadow-lg rounded-2xl backdrop-filter backdrop-blur-lg bg-gradient-to-r from-[rgba(255,255,255,0.4)] to-[rgba(255,255,255,0.2)] box-border text-white">
                ...
                <button
                  ...
                  className="bg-transparent border-white border px-6 hover:bg-black text-white font-bold text-xl rounded-full transition duration-1000 w-[198px] mt-8 lg:mt-0"
                >
                  VISIT
                </button>
              </div>
